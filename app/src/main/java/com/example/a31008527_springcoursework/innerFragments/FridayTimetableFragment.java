...
public class FridayTimetableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        itemTimetableModules.add(new itemTimetableModule(getString(R.string.iwlp_german_1),
                "JJ Thompson Slingo Theatre", "14:00", "15:00"));
        itemTimetableModules.add(new itemTimetableModule(getString(R.string.algorithms_and_operating_system),
                "JJ Thompson Ditchburn Theatre", "15:00", "16:00"));
